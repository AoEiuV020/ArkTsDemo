...
1. 禁止`| undefined`， 都应该改成问号， 而且不必要的undefined初始化可以删除，

1. 检查所有fileio使用， 全都不要使用Sync函数， 删除Sync结尾就是个异步函数， 使用异步await,

1. 检查entry/src/main/ets/pages/Index.ets没用到的过时代码可以删除了，

1. entry/src/main/ets/audio 这里有过时代码，

1. 调整vm， 录音和播放应该分两个vm，

1. 检查播放， 目前播放中再次点击播放会变成idle，不会重新播放， 希望效果是重新播放， 
